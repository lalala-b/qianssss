...
interface SelfConfirmOrderPropsType {
  editInfo: boolean;
  submit: boolean;
  busOrderType: number;
  orderBelongType?: number;
  onSubmit: (params: any) => void;
}

const SelfConfirmOrder: React.FC<SelfConfirmOrderPropsType> = ({
  editInfo,
  orderBelongType,
  submit,
  onSubmit,
  ...
  const handleSubmit = async () => {
    ...
    const params = {
      // 区分海盗和自营 海盗取orderBelongType
      belongType: orderBelongType || 0,
...
export default SelfConfirmOrder;
