...
import SignConfirmOrder from "./SignConfirmOrder";
import SelfConfirmOrder from "./SelfConfirmOrder";
import MediumConfirmOrder from "./MediumConfirmOrder";
          ...
          <div className={cs(styles.wrapper, "m-t-24")}>
            ...
            {+orderBelongType === 3 && (
              <SelfConfirmOrder
                ...
                onSubmit={handleSubmit}
                busOrderType={busOrderType}
                orderBelongType={+orderBelongType}
              />
            )}
