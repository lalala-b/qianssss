...
import styles from "../ConfirmReceiptPay.scss";
...
const ConfirmReceiptPayWrapForSign: React.FC = () => {
  const {
    detail: {
      // orderBaseInfoBO: { orderBelongType = 0 } = {},
                  ...
                  {paymentChannel === 1 || paymentChannel === 2 ? (
                    ...
                    <Col span={8}>
                      <Form.Item
                        ...
                        // rules={[{ required: true, message: "请上传款项截图" }]}
                      >
...
export default ConfirmReceiptPayWrapForSign;
