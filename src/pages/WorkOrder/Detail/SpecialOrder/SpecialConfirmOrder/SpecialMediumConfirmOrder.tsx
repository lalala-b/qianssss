...
interface SpecialMediumConfirmOrderPropsType {
  editInfo: boolean;
  submit: boolean;
  busOrderType: number;
...
const SpecialMediumConfirmOrder: React.FC<
  SpecialMediumConfirmOrderPropsType
> = ({ editInfo, submit, onSubmit }) => {
...
export default SpecialMediumConfirmOrder;
