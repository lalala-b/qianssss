...
interface SpecialSignConfirmOrderPropsType {
  editInfo: boolean;
  submit: boolean;
  busOrderType?: number;
...
const SpecialSignConfirmOrder: React.FC<SpecialSignConfirmOrderPropsType> = ({
  editInfo,
  submit,
  onSubmit,
}) => {
...
export default SpecialSignConfirmOrder;
