...
export interface OrderListRequest {
  ...
  export interface OverListType {
    outlineOvertimeSoonCount:number;
    outlineOvertimeCount:number;
    scriptOvertimeSoonCount:number;
    scriptOvertimeCount:number;
    draftOvertimeSoonCount:number;
    draftOvertimeCount:number;
    publishOvertimeSoonCount:number;
    publishOvertimeCount:number;
  }
