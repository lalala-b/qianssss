...
/* 该文件由 @zz-common/zapi-to-typescript 自动生成，请勿直接修改！！！ */

/**
 * 接口 [列表接口↗](http://zapi.zhuanspirit.com/project/3631/interface/api/1967490) 的 **请求类型**
 *
